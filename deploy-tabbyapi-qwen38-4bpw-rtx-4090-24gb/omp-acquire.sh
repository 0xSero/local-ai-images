...
set -e
N="Qwen3.8-27B-EXL3-SC4bpw-H5"; D="/opt/models/$N"; REPO="turboderp/Qwen3.8-27B-exl3"; REV="4acd9ad5af224ec9e8815a54d71a033f378a7e9d"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
