...
set -e
N="Qwen3.8-Flash-Next-EXL3-205bpw-H4"; D="/opt/models/$N"; REPO="turboderp/Qwen3.8-Flash-Next-exl3"; REV="65c895314393431c09050b2e04e250836b3a6eb4"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
