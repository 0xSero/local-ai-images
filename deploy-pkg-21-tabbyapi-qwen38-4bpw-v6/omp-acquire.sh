...
set -e
N="Qwen3.8-27B-EXL3-SC4bpw-H5-V6"; D="/opt/models/$N"; REPO="turboderp/Qwen3.8-27B-exl3"; REV="516bf129059031c6da9416768ea6b7a1be00a8fc"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
