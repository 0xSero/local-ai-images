...
set -e
N="MiniCPM5-2B-AWQ-INT4"; D="/opt/models/$N"; REPO="cyankiwi/MiniCPM5-2B-AWQ-INT4"; REV="bc59eebcb2e12f5e1e714c57a4b6b7527f6cd845"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
