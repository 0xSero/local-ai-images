...
set -e
N="Qwen3.8-27B-EXL3-SC2bpw-H3-V3"; D="/opt/models/$N"; REPO="turboderp/Qwen3.8-27B-exl3"; REV="e5e1f4b37c77641e465e24adf5f44d01bdd48de2"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
