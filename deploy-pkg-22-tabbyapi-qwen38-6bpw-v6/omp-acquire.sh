...
set -e
N="Qwen3.8-27B-EXL3-SC6bpw-H6-V6"; D="/opt/models/$N"; REPO="turboderp/Qwen3.8-27B-exl3"; REV="60d005a257b39ecb25e4ba23c1dd29df877d5c69"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
