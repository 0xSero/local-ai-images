...
set -e
N="Qwen3.8-27B-AWQ-INT4"; D="/opt/models/$N"; REPO="cyankiwi/Qwen3.8-27B-AWQ-INT4"; REV="63768c10df38c0395e12ef49edac1bd539eaeeea"; LOG="/opt/logs/deploy-preflight.log"
mkdir -p /opt/logs "$D"
